...
topic = "$aws/things/cloud_lab_3_thing_4/shadow/update"
publish_url = 'https://' + endpoint + ':8443/topics/' + topic + '?qos=1'

sensor_id = 4
name = "name_4"
settlement = "settlement_4"
latitude = "14.1234567"
longtitude = "14.1234567"
water_level = 14
...
while True:
        ...
        publish = requests.request('POST',publish_url ,data=messageJson,cert=[cert_path, key_path])
